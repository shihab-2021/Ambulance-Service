  ...
  const steps = [
    {
      ...
      icon: <FaUserAlt className="text-5xl text-red-600" />,
    },
    {
    ...
    },
    {
      ...
      icon: <FaCheck className="text-5xl text-red-600" />,
    },
    {
    ...
    <section className="py-16 mb-28 font-sansita">
      <div className="container mx-auto px-8">
        <div className="flex items-center justify-center flex-col mb-16">
          ...
          <hr className="w-[73px] border-b-4 border-red-300 rounded-full" />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div
              key={index}
              className="rounded-lg shadow-md p-6 bg-white border-t-4 border-red-500 hover:bg-red-50 hover:border-red-600 transition transform hover:scale-105 hover:shadow-lg duration-300"
            >
      ...
      <section className="container mx-auto px-4  ">
        <div className="bg-gradient-to-r from-gray-600 to-red-400 py-20 mt-40 rounded-xl text-center">
          ...
          <Link
            href="/aboutUs"
            className="bg-white text-red-500 hover:bg-red-500 hover:text-white py-2 px-4 rounded-full font-semibold transition duration-300"
          >
            Learn More
          </Link>
        </div>
