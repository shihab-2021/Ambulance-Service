    ...
    <div className="bg-black font-sansita">
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl xl:max-w-screen-xl 2xl:max-w-screen-2xl md:px-24 lg:px-8">
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 lg:max-w-sm">
              <p className="text-sm text-white">
                Thank you for visiting our ambulance service website. We are
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              ...
              <a
                href="mailto:service@ambulace.com"
                aria-label="Our email"
                title="Our email"
                className="transition-colors duration-300 text-white hover:text-deep-purple-800"
              >
                service@ambulace.com
              </a>
            </div>
            <div className="flex">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-white">
              For any inquiries or to request our services, please feel free to
              contact us using the information provided below. We are available
              24/7 to respond to emergency calls and provide timely medical
              assistance
            </p>
          </div>
        </div>
        <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
          <p className="text-sm text-white">
            © Copyright 2023 Ambulace Service. All rights reserved.
          </p>
          <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
            <li>
              <a
                href="/"
                className="text-sm text-white transition-colors duration-300 hover:text-primary"
              >
                F.A.Q
              </a>
            </li>
